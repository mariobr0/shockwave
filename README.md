...
- **Gemini (`gemini-2.5-flash-lite`)**: A lightweight and fast model from Google's Gemini lineup. Used for punctuation restoration, formatting, and terminology correction.
...
* **Interactive UI:** A floating widget with checkboxes to toggle AI correction and sound alerts.
* **Backup Log:** The console saves logs with transcription history, preventing data loss.
...
* **Бекап-лог:** Консоль сохраняет логи вместе с историей расшифровок, не позволяя потерять текст.
